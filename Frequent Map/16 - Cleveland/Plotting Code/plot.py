...
plt.title('16 - Cleveland Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-81.6944
, lat_0=41.4993)
...
plotData(map, ['GCRTA Data'], min_draw_size)

plotData(map, ['Cuyahoga Railroad Data'], min_draw_size)

plt.savefig('map16.png')
plt.show()