...
plt.title('9 - Miami Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-80.1918
, lat_0=25.7617)
...
plotData(map, ['Broward County Data'], min_draw_size)

plotData(map, ['MDC Transit Data'], min_draw_size)

plt.savefig('map9.png')
plt.show()