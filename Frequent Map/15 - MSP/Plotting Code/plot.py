...
plt.title('15 - Minneapolis/St. Paul Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-93.2010
, lat_0=44.9375)
...
plotData(map, ['Metro Transit Data'], min_draw_size)

plt.savefig('map15.png')
plt.show()