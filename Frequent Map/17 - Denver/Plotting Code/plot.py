...
plt.title('17 - Denver Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-104.9847000
, lat_0=39.7391500)
...
plotData(map, ['Denver Data'], min_draw_size)

plt.savefig('map17.png')
plt.show()