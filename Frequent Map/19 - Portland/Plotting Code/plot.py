...
plt.title('19 - Portland Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-122.6765
, lat_0=45.5231)
...
# plotData(map, ['TriMet Data'], min_draw_size)

plotData(map, ['Blue Star Data'], min_draw_size)

plotData(map, ['Caravan Data'], min_draw_size)

plotData(map, ['CCC Xpress Data'], min_draw_size)

plotData(map, ['HUT Airport Shuttle Data'], min_draw_size)

plotData(map, ['Mt Hood Express Data'], min_draw_size)

plotData(map, ['Ride Connection Data'], min_draw_size)

plotData(map, ['SAM Data'], min_draw_size)

plotData(map, ['SMART Data'], min_draw_size)

plotData(map, ['Swan Island Data'], min_draw_size)

plotData(map, ['Woodburn Data'], min_draw_size)

plotData(map, ['Yamhill Data'], min_draw_size)

plt.savefig('map19.png')
plt.show()