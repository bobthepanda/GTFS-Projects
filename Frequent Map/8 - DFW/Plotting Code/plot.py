...
plt.title('8 - Dallas/Fort Worth Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-97.0403
, lat_0=32.8998)
...
plotData(map, ['FWTA Data'], min_draw_size)

plotData(map, ['DART Data'], min_draw_size)

plt.savefig('map8.png')
plt.show()