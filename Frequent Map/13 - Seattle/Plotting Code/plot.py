...
plt.title('13 - Seattle Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-122.3321
, lat_0=47.6062)
...
# shapes.txt does not exist.
# plotData(map, ['Seattle Hospital Data'], min_draw_size)

plotData(map, ['Kitsap Data'], min_draw_size)

plotData(map, ['Ferries Data'], min_draw_size)

plotData(map, ['Pierce Data'], min_draw_size)

plotData(map, ['Sound Transit Data'], min_draw_size)

plotData(map, ['King County Data'], min_draw_size)

plt.savefig('map13.png')
plt.show()