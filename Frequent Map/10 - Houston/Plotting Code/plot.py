...
plt.title('10 - Houston Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-95.3632700
, lat_0=29.7632800)
...
plotData(map, ['Houston Data'], min_draw_size)

plt.savefig('map10.png')
plt.show()