...
plt.title('11 - Atlanta Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-84.3880
, lat_0=33.7490)
...
plotData(map, ['Cobb Data'], min_draw_size)

plotData(map, ['Atlanta Data'], min_draw_size)

plotData(map, ['GRTA Data'], min_draw_size)

plotData(map, ['MARTA Data'], min_draw_size)

plt.savefig('map11.png')
plt.show()