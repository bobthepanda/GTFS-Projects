...
# Create a m of New York City centered on Manhattan.
plt.figure(figsize=(12, 12), dpi=72)
plt.title('3 - Chicago Transit Frequency')
m = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-87.623177, lat_0=41.881832)
...
plotData(m, ['CTA Data'], min_draw_size)

# Pace GTFS lacks the necessary shapes.txt.
# plotData(m, ['Pace Data'], min_draw_size)

# Metra GTFS has shapes.txt, but no corresponding shape_ids in trips.txt.
# plotData(m, ['Metra Data'], min_draw_size * 2)
