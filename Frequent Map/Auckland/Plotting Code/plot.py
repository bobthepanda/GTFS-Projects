...
plt.title('Auckland Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=174.7633, lat_0=-36.8485)

plotData(map, ['Auckland Data'], min_draw_size)
