...
plt.title('20 - Orlando Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-81.3792
, lat_0=28.5383)
...
plotData(map, ['Lynx Data'], min_draw_size)

plt.savefig('map20.png')
plt.show()