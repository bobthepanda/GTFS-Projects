...
plt.title('12 - Detroit Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-83.0458
, lat_0=42.3314)
...
plotData(map, ['Detroit Data'], min_draw_size)

plt.savefig('map12.png')
plt.show()