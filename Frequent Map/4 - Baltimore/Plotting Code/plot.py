...
plt.title('4 - Baltimore Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-76.609383
, lat_0=39.299236)
...
plotData(map, ['RTA Data'], min_draw_size)

plotData(map, ['BWI Data'], min_draw_size)

plotData(map, ['CMRT Data'], min_draw_size)

plotData(map, ['Annapolis Data'], min_draw_size)
