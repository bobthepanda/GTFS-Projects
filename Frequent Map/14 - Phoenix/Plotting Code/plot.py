...
plt.figure(figsize=(12, 12), dpi=72, frameon=False)
plt.title('14 - Phoenix Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-112.0740
, lat_0=33.4484)
...
# plotData(map, ['Valley Metro Data'], min_draw_size)

plt.savefig('map14.png')
plt.show()