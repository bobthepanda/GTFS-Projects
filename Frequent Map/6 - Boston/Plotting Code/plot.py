...
plt.title('6 - Boston Transit Frequency')
map = Basemap(resolution="h", projection="stere", width=80000, height=80000, lon_0=-71.060093
, lat_0=42.359968)
...
plotData(map, ['Boston Data'], min_draw_size)

plotData(map, ['Brockton Data'], min_draw_size)

plotData(map, ['Lowell Data'], min_draw_size)

plotData(map, ['Metrowest Data'], min_draw_size)

plt.savefig('map6.png')
plt.show()